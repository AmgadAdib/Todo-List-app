...
import { TodoType, ColumnsType, ColumnNameType } from './Interface';
import { todoContext } from "./todoContext";
import Add from './Add';
import Edit from './Edit';


const Column = ({columnName}: ColumnNameType) => {

    const { todoList, setTodoList } = useContext<ColumnsType>(todoContext)
